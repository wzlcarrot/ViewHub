...
public class CategoryInfoQuery extends BaseParam {
	...
	private Integer categoryIdOrPCategoryId;  //分类ID或父级分类ID

	private Boolean convertTree;

	public void setConvertTree(Boolean convertTree){
		this.convertTree = convertTree;
	}

	public Boolean getConvertTree(){
		return this.convertTree;
	}
	...
	public Integer getCategoryIdOrPCategoryId(){
		return this.categoryIdOrPCategoryId;
	}
